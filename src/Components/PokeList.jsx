...
//console.log(saveData.length>0 && saveData[0][1])
    return (
        ...
        <Main>
            <Row>
                <Col><LinkPokes to={`/PokeInfo/${saveData.length>0 && saveData[0][0]}`}>{saveData.length>0 && saveData[0][0]}</LinkPokes></Col>
                <Col><LinkPokes to={`/PokeInfo/${saveData.length>1 && saveData[1][0]}`}>{saveData.length>1 && saveData[1][0]}</LinkPokes></Col>
                <Col><LinkPokes to={`/PokeInfo/${saveData.length>2 && saveData[2][0]}`}>{saveData.length>2 && saveData[2][0]}</LinkPokes></Col>
                <Col><LinkPokes to={`/PokeInfo/${saveData.length>3 && saveData[3][0]}`}>{saveData.length>3 && saveData[3][0]}</LinkPokes></Col>
                <Col><LinkPokes to={`/PokeInfo/${saveData.length>4 && saveData[4][0]}`}>{saveData.length>4 && saveData[4][0]}</LinkPokes></Col>
            </Row>
            <Row>
                <Col><LinkPokes to={`/PokeInfo/${saveData.length>5 && saveData[5][0]}`}>{saveData.length>5 && saveData[5][0]}</LinkPokes></Col>
                <Col><LinkPokes to={`/PokeInfo/${saveData.length>6 && saveData[6][0]}`}>{saveData.length>6 && saveData[6][0]}</LinkPokes></Col>
                <Col><LinkPokes to={`/PokeInfo/${saveData.length>7 && saveData[7][0]}`}>{saveData.length>7 && saveData[7][0]}</LinkPokes></Col>
                <Col><LinkPokes to={`/PokeInfo/${saveData.length>8 && saveData[8][0]}`}>{saveData.length>8 && saveData[8][0]}</LinkPokes></Col>
                <Col><LinkPokes to={`/PokeInfo/${saveData.length>9 && saveData[9][0]}`}>{saveData.length>9 && saveData[9][0]}</LinkPokes></Col>
            </Row>
            <Row>
                <Col><LinkPokes to={`/PokeInfo/${saveData.length>10 && saveData[10][0]}`}>{saveData.length>10 && saveData[10][0]}</LinkPokes></Col>
                <Col><LinkPokes to={`/PokeInfo/${saveData.length>11 && saveData[11][0]}`}>{saveData.length>11 && saveData[11][0]}</LinkPokes></Col>
                <Col><LinkPokes to={`/PokeInfo/${saveData.length>12 && saveData[12][0]}`}>{saveData.length>12 && saveData[12][0]}</LinkPokes></Col>
                <Col><LinkPokes to={`/PokeInfo/${saveData.length>13 && saveData[13][0]}`}>{saveData.length>13 && saveData[13][0]}</LinkPokes></Col>
                <Col><LinkPokes to={`/PokeInfo/${saveData.length>14 && saveData[14][0]}`}>{saveData.length>14 && saveData[14][0]}</LinkPokes></Col>
            </Row>
            <Row>
                <Col><LinkPokes to={`/PokeInfo/${saveData.length>15 && saveData[15][0]}`}>{saveData.length>15 && saveData[15][0]}</LinkPokes></Col>
                <Col><LinkPokes to={`/PokeInfo/${saveData.length>16 && saveData[16][0]}`}>{saveData.length>16 && saveData[16][0]}</LinkPokes></Col>
                <Col><LinkPokes to={`/PokeInfo/${saveData.length>17 && saveData[17][0]}`}>{saveData.length>17 && saveData[17][0]}</LinkPokes></Col>
                <Col><LinkPokes to={`/PokeInfo/${saveData.length>18 && saveData[18][0]}`}>{saveData.length>18 && saveData[18][0]}</LinkPokes></Col>
                <Col><LinkPokes to={`/PokeInfo/${saveData.length>19 && saveData[19][0]}`}>{saveData.length>19 && saveData[19][0]}</LinkPokes></Col>
            </Row>
